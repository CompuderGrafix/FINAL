...
void createModels(GLuint vPosition, GLuint vNormal, GLuint uMaterialAmbient, GLuint uMaterialDiffuse, GLuint uMaterialSpecular, GLuint uMaterialShininess) {
...
void init(void) {
  ...
  createModels(vPosition, vNormal, uMaterialAmbient, uMaterialDiffuse, uMaterialSpecular, uMaterialShininess);
